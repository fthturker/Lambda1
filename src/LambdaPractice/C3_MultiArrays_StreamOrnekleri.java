...
public class C3_MultiArrays_StreamOrnekleri {
    public static void main(String[] args) {
        ...
        doubleYaz((arr));
        System.out.println(EleriYazListele(arr));
    ...
    public static List<String> EleriYazListele(String[][] str) {
        return Arrays.
                stream(str).flatMap(t->Arrays.stream(t)).filter(t->t.startsWith("E")).collect(Collectors.toList());
    }
